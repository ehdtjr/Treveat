...
class _review_modify extends State<review_modify> {
  ...
  String token_key = token; //로그인 정보 받아와서 넣기
  String author = nickname; //로그인 정보 받아와서 넣기
            ...
            child:(isLoading==false)?ElevatedButton(
              onPressed: () async {
                if (formkey.currentState!.validate()) {
                  ...
                  await call(no,loc_code,token_key,author,regdate,rating,content,pickedimage).then((value) => setState(() {
                    response = value;
                  }));
                  setState(()  {
                    isLoading=false;
